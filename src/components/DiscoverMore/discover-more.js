          ...
          <div className="row">
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Wallets</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
                  </h4>
                  <h4 className="text-blue6">
                    <p>Bitcoin.org</p>
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Exchanges</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Explorers</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Merchants</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Projects</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
            ...
            <div className="col-4 p-r-55 m-t-55">
              <div className="card text-center">
                ...
                <div className="card__body">
                  <h4 className="fs-22 text-blue2 font-weight-bold">Knowledge</h4>
                  <h4 className="text-dark1 a26">
                    Lorem ipsum dolor sit amet, <br/>
                    consectetur adipiscing elit. Sed blandit <br/>
                    feugiat porta. Aliquam <br/>
